...
while True:
	...
	if status:
		...
		#convertir datos en porcentajes de confianza
		piedra = int(predictions[0][0]*100)
		papel = int(predictions[0][1]*100)
		tijeras = int(predictions[0][2]*100)
		#imprimir porjentajes de confianza
		print("Piedra: {piedra}%, Papel: {papel}%, Tijeras: {tijeras}%")
